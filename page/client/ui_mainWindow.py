...
"}")
        ...
        self.diaResult_2 = QtWidgets.QLabel(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.diaResult_2.sizePolicy().hasHeightForWidth())
        self.diaResult_2.setSizePolicy(sizePolicy)
        self.diaResult_2.setMaximumSize(QtCore.QSize(100, 30))
        self.diaResult_2.setObjectName("diaResult_2")
        self.horizontalLayout_2.addWidget(self.diaResult_2)
...
"border-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.diaButton.setText(_translate("MainWindow", "诊断"))
        self.caButton.setText(_translate("MainWindow", "元胞自动机（CA）"))
        self.pushButton.setText(_translate("MainWindow", "Dice系数"))
        self.diaResult.setText(_translate("MainWindow", "结果:"))
        self.diaResult_2.setText(_translate("MainWindow", "Dice:           "))
        self.groupBox.setTitle(_translate("MainWindow", "效果图"))
        self.label.setText(_translate("MainWindow", "原始图像"))
        self.label_2.setText(_translate("MainWindow", "分割结果"))
