...
"}")
        ...
        self.IncButton = QtWidgets.QPushButton(self.layoutWidget)
        self.IncButton.setObjectName("IncButton")
        self.horizontalLayout.addWidget(self.IncButton)
        self.knnButton = QtWidgets.QPushButton(self.layoutWidget)
        self.knnButton.setObjectName("knnButton")
        self.horizontalLayout.addWidget(self.knnButton)
...
"border-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.IncButton.setText(_translate("MainWindow", "Inception"))
